...
Text;
    ...
    internal partial class NhaHat
    {
        ...
        protected static void Main()
        {
            ...
            while (true)
            {
                string chiHuyLine = Console.ReadLine(); if (chiHuyLine == null)
                {
                    return;
                }
    ...
    chiHuyParts
        ...
        [0];
                    ...
                    try
                    {
                        switch (chiHuy)
                        {
                            case "AddTheatre": chiHuyParts = chiHuyLine.Split('('); chiHuy = chiHuyParts[0]; string[] chiHuyParts1 = chiHuyLine.Split(
